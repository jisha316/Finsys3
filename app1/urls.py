...
urlpatterns = [
    ...
    re_path(r'^vendordetails2$',views.vendordetails2,name='vendordetails1'),
    re_path(r'^vendordetails3$',views.vendordetails3,name='vendordetails1'),
    re_path(r'^new_customersp$',views.new_customersp,name='new_customersp'),
    ...
    re_path(r'^viewbilling/(?P<id>\d+)$',views.viewbilling,name='viewbilling'),
    re_path(r'^viewbilling/deletebill/(?P<id>\d+)$',views.deletebill,name='deletebill'),
    re_path(r'^billconvert/(?P<id>\d+)$',views.billconvert,name='billconvert'),
    re_path(r'^viewbilling/goeditbill/(?P<id>\d+)$',views.goeditbill,name='goeditbill'),
    re_path(r'^viewbilling/goeditbill/editpurchasebill/(?P<id>\d+)$',views.editpurchasebill,name='editpurchasebill'),
